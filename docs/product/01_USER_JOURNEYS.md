...
Acts as the final strategic decision maker and is accountable for the overall success of the business.
...
- Review AI executive brief
- Monitor revenue and delivery health
...
Requires board approval only where legally applicable.

#### 4. Daily Workflow

##### Morning

- Executive Brief generated by AGE
...
**Primary Dashboard:** Executive Command Center
...
The CEO should understand the complete health of the business within five minutes of logging into AGE.
...
Every executive decision must record:
...
Ensure every client engagement is delivered efficiently, profitably, and consistently while maintaining the highest standards of quality and operational excellence.
...
- Scale operations without reducing quality

**Business Value**

Owns operational excellence by aligning people, processes, AI agents, and delivery systems to achieve predictable outcomes.

#### 2. Responsibilities

##### Daily

- Review Operations Command Center
...
Escalates strategic investments and organizational restructuring to the Founder / CEO.
...
**Primary Dashboard:** Operations Command Center
...
Only operationally significant notifications.
...
Can approve delivery-related decisions.
...
The COO should understand the operational health of every active client and project within five minutes of logging into AGE.
...
Every operational decision must record:
...
**Primary Dashboard:** Growth Command Center
...
Every SEO decision must record:
...
A matrix showing collaboration between every persona, with columns:
