...
- `IntegrationAggregate` — the canonical domain root.

## Repository port

- `IntegrationRepository` (interface only).

## Identifier

- `IntegrationId` — re-exported from `@age/shared` (single UniqueId-based identity).
