...
Growth strategies, objectives and plans.
...
- `StrategyAggregate` — the canonical domain root.

## Repository port

- `StrategyRepository` (interface only).

## Identifier

- `StrategyId` — re-exported from `@age/shared` (single UniqueId-based identity).
