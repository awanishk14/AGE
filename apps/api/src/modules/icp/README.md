...
Ideal Customer Profiles — who to target.
...
- `IcpAggregate` — the canonical domain root.

## Repository port

- `IcpRepository` (interface only).

## Identifier

- `IcpId` — re-exported from `@age/shared` (single UniqueId-based identity).
